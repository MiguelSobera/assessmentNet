...
namespace assessmentNet.Controllers
{
    ...
    {
        private readonly miguelpenadatabaseContext _context;

        public VehiclesController(miguelpenadatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var miguelpenadatabaseContext = _context.Vehicles.Include(v => v.Owner);
            return View(await miguelpenadatabaseContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'miguelpenadatabaseContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
