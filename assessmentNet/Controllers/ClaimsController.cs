...
namespace assessmentNet.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(miguelpenadatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var miguelpenadatabaseContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'miguelpenadatabaseContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
